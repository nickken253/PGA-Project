        ...
        >
          {(values) => (
            <Form className={"w-full"}>
              ...
              <FormGroup>
                <FormLabel children="Confirm Password" htmlFor="confirmPassword" />
                <FormField type="password" placeholder="Confirm Password" validate={(value: string) => validateConfirmPassword(value, values)} id="confirmPassword" name="confirmPassword" />
              </FormGroup>
              <FormError component="a" name="confirmPassword" />

              <FormGroup>
                <FormLabel children="Full Name" htmlFor="FullName" />
                <FormField type="text" placeholder="Full Name" validate={validateEmail} id="fullName" name="fullName" />
              </FormGroup>
